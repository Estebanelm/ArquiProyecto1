...
##ingresar strings de cualquier tamaño sin tener que contarlas.
...
##continúa el proceso. Si el segundo string llega al caracter 00, se
...
matched:
	...
	add $t0, $zero, 1 ##Esta linea está solo para poder hacer un breakpoint a la hora de debuguear
